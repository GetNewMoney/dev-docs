...
```bash
curl -i -X POST https://api.getnewmoney.io/mint \
  -H "Content-Type: application/json" \
  -d '{"apiKey": "your-api-key", "amount": 100}'
```
...
```bash
curl -v -X POST https://api.getnewmoney.io/mint \
  -H "Content-Type: application/json" \
  -d '{"apiKey": "your-api-key", "amount": 100}'
```
...
```bash
curl -s -X POST https://api.getnewmoney.io/mint \
  -H "Content-Type: application/json" \
  -d '{"apiKey": "your-api-key", "amount": 100}'
```
...
curl --connect-timeout 10 --max-time 30 \
  -X POST https://api.getnewmoney.io/mint \
  -H "Content-Type: application/json" \
  -d '{"apiKey": "your-api-key", "amount": 100}'
```
...
# Make request
RESPONSE=$(curl -s -w "\n%{http_code}" -X POST https://api.getnewmoney.io/mint \
  -H "Content-Type: application/json" \
  -d "{
    \"apiKey\": \"$API_KEY\",
    \"amount\": $AMOUNT,
...
for amount in "${AMOUNTS[@]}"; do
  ...
  RESPONSE=$(curl -s -X POST https://api.getnewmoney.io/mint \
    -H "Content-Type: application/json" \
    -d "{
      \"apiKey\": \"$API_KEY\",
      \"amount\": $amount,
...
```bash
curl -X GET https://api.getnewmoney.io/mint
```
